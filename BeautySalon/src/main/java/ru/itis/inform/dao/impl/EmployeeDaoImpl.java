...
public class EmployeeDaoImpl implements EmployeeDao {
    ...
    public List<Record> getEmployeeRecordsById(int id) {
        Map<String, Object> params = new HashMap<>();
        params.put("employeeId", id);
        return namedParameterJdbcTemplate.query(SQL_GET_RECORDS_BY_ID, params, new EmployeeMapper());
    }
    ...
    public List<WorkTime> getEmployeeWorkTime(int id) {
        Map<String, Object> params = new HashMap<>();
        params.put("employeeId", id);
        return namedParameterJdbcTemplate.query(SQL_GET_WORK_TIME, params, new EmployeeMapper());
    }
